...
public class Autenticação_Page extends BasePage {
    public Autenticação_Page(WebDriver navegador) {
        super(navegador);
    }

    public Autenticação_Page criarConta() throws InterruptedException {
        ...
        public CriarConta_Page clicarBotaoCreateAnAccount () throws InterruptedException {
            //Clicar no botão Create an account
            navegador.findElement(By.id("SubmitCreate")).click();
            Thread.sleep(2000);

            return new CriarConta_Page(navegador);
        }
    }
